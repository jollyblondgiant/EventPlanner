...
namespace Activity.Controllers
{
    ...
    {
        private ActivityContext _dbContext;
        ...
        public IActionResult Register(User newUser)
        {
            ...
            if(_dbContext.Users.Any(c=>c.Email == newUser.Email))
            {
        ...
        {
            User DbUser = _dbContext.Users.FirstOrDefault(c=>c.Email == _logUSer.LoginEmail);
            if(DbUser == null)
            {
        ...
        public IActionResult NewEvent(Event newEvent)
        {
            ...
            {
                int? seshUser = HttpContext.Session.GetInt32("ID");
                User EventCreator = _dbContext.Users.FirstOrDefault(u=>u.ID == seshUser);
        ...
        public IActionResult ViewEvent(int eventID)
        {
            ...
            Event thisEvent = _dbContext.Events
            .Include(u=>u.Participants)
        ...
        public IActionResult DeleteEvent(int eventID)
        {
            ...
            _dbContext.Events.Remove(thisEvent);
            _dbContext.SaveChanges();
            return Redirect("/home");
        ...
        public IActionResult JoinEvent(int eventID)
        {
            ...
            _dbContext.Participants.Add(newPart);
            _dbContext.SaveChanges();
            return Redirect("/home");
        }
        ...
        public IActionResult LeaveEvent(int eventID)
        {
            ...
            int? seshUser = HttpContext.Session.GetInt32("ID");
            List<Participant> thisParts = _dbContext.Participants
            ...
            foreach(var part in thisParts)
            {
                ...
                {
                    thisPart = part;
                    _dbContext.Participants.Remove(thisPart);
                    _dbContext.SaveChanges();
                }
            }
            return Redirect("/home");
